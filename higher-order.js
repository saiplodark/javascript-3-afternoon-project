...
*/
let findbob = purchases.filter(element => element.owner === "Bob");
let bobsTotal = findbob.reduce((acc, curr) => acc + curr.price, 0)


// sum up the array of objects, must supply initial value 